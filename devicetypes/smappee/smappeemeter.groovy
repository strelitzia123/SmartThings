...
metadata {
    definition (name: "Smappee Meter", namespace: "smappee", author: "Chuck J", oauth: true) {
    ...
    tiles(scale: 2) {
        multiAttributeTile(name:"power", type:"generic", width:6, height:4) {
            tileAttribute("device.power", key: "PRIMARY_CONTROL") {
                attributeState "default", label:'${currentValue} W', backgroundColor: "#2D3935"
            }
        }

        valueTile("AlwaysOn", "device.AlwaysOn", decoration: "ring", width:2, height:2) {
            state "default", label:'${currentValue} W', backgroundColor: "#4587A7"
        }
